...
namespace conf
{
    ...
    /// Draw ToolStrips.
    /// </summary>
    public class SkinRenderer : ToolStripProfessionalRenderer
    {
        ...
        private static Color _c2 = Color.FromArgb(0, 0, 0);
        ...
        private static Color _r1 = Color.LightGray;
        private static Color _r2 = Color.FromArgb(240, 240, 240);
        ...
        private static Color _r9 = SystemColors.Control;
        ...
        */
        ...
        private static Color _r7 = Color.FromArgb(255, 213, 103);
        private static Color _r8 = Color.FromArgb(255, 228, 145);
        private static Color _r9 = Color.FromArgb(160, 160, 160); // top and bottom button border
        private static Color _rA = Color.FromArgb(160, 160, 160); // middle button border
        private static Color _rB = Color.FromArgb(182, 190, 192);
        private static Color _rC = Color.FromArgb(155, 163, 167);
        private static Color _rD = Color.FromArgb(233, 168, 97);
        private static Color _rE = Color.FromArgb(247, 164, 39);
        ...
        /// <summary>
        /// Initialize a new instance of the SkinRenderer class.
        /// </summary>
        public SkinRenderer()
            : base(new SkinColorTable())
        {
        }
        #endregion
