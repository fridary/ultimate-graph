...
namespace conf
{
    ...
    /// Theme colors
    /// </summary>
    public class SkinColorTable : ProfessionalColorTable
    {
        ...
        private static Color _gripDark = Color.FromArgb(160, 160, 160);
        ...
        private static Color _overflowBegin = Color.FromArgb(250, 250, 250);
        private static Color _overflowEnd = Color.FromArgb(178, 178, 178);
        private static Color _overflowMiddle = Color.FromArgb(198, 198, 198);
        private static Color _menuToolBack = Color.WhiteSmoke;
        private static Color _separatorDark = Color.FromArgb(158, 158, 158);
        private static Color _separatorLight = Color.FromArgb(255, 255, 255);
        private static Color _statusStripLight = SystemColors.Control; // FromArgb(215, 229, 247)
        private static Color _statusStripDark = SystemColors.Control; // FromArgb(172, 201, 238)
        private static Color _toolStripBorder = Color.WhiteSmoke;
        private static Color _toolStripContentEnd = Color.FromArgb(164, 195, 235);
        private static Color _toolStripBegin = Color.FromArgb(253, 253, 253);
        private static Color _toolStripEnd = SystemColors.Control;
        private static Color _toolStripMiddle = Color.FromArgb(248, 248, 248);
        private static Color _buttonBorder = Color.FromArgb(121, 153, 194);
        #endregion

        #region Identity
        /// <summary>
        /// Initialize a new instance of the SkinColorTable class.
        /// </summary>
        public SkinColorTable()
        {
        }
        #endregion
